...
result = lineSearch(    @func_Rosenbrock,...
                        ...
                        iterationLimit,...
                        epsilon,...
                        @p_steepestDescent,...  % Directions by steepest descent.
                        [],...                  % No parameters necessary (see p_steepestDescent).
                        @alpha_backtracking,... % Steplength by backtracking.
